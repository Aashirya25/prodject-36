class Question {
  ...
  display(){
    ...
    this.question.html("Question: What travels around the world but stays in one corner?" );
    // question.html("Question: What starts and ends with the letter ‘E’, but has only one letter? " );

    this.question.position(150, 80);
    this.option1.html("1: Letter " );
    this.option1.position(150, 100);
    this.option2.html("2: Envelope" );
    this.option2.position(150, 120);
    this.option3.html("3: Postage stamp " );
    this.option3.position(150, 140);
    this.option4.html("4: Other please mention" );
